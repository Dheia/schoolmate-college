...
use App\Http\Requests\SpendMoneyRequest as StoreRequest;
use App\Http\Requests\SpendMoneyRequest as UpdateRequest;

class SpendMoneyCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\SpendMoney');
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/spend-money');
        $this->crud->setEntityNameStrings('Spend Money', 'Spend Money');
