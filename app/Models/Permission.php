...
class Permission extends Model
{
    ...
    */
    ...
    protected $fillable = ['name', 'page_name', 'guard_name'];
    ...
    public static function create(array $attributes = [])
    {
        ...
        $permission = static::getPermissions()->filter(function ($permission) use ($attributes) {
            return $permission->name === $attributes['name'] && $permission->page_name == $attributes['page_name'] && $permission->guard_name === $attributes['guard_name'];
        })->first();
