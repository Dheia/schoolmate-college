<template>
    <div class="container-fluid" style="padding: 0; margin: 0;">
            ...
            <table class="table table-bordered mb-0">
                <tbody>
                    <tr>
                        ...
                        <td id="employeeID">&nbsp; 
                            <span v-if="selectedEmployee != null">{{ selectedEmployee.employee_id }}</span>
                        </td>
                        
                        <td><b><small>Fullname:</small></b></td>
                        <td id="fullname">&nbsp; 
                            <span v-if="selectedEmployee != null">{{ selectedEmployee.full_name }}</span>
                        </td>
                        
                        <td><b><small>Position:</small></b></td>
                        <td id="position">&nbsp; 
                            <span v-if="selectedEmployee != null">{{ selectedEmployee.position }}</span>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="col-md-11 col-sm-10" style="padding: 0; margin: 0">
            <input v-model="searchbar" @keyup.enter="searchNow()" type="text" class="form-control" id="search" placeholder="Employee ID No.">
        </div>
        ...
        <div v-if="borrowedBooks == null" class="col-md-12 " id="first-view" style="margin-top: 40px;">
            <h4 class="text-center">SEARCH FOR EMPLOYEE LIBRARY RECORD</h4> 
                      ...
                      <div class="modal-content">
                        ...
                        <form @submit.prevent="returnBook">
                          ...
                          <div class="modal-body">
                            <input v-if="selectedEmployee != null" type="hidden" :id="return_book_id" :name="return_book_id" :value="return_book_id">
                            <input v-if="selectedEmployee != null" type="hidden" :id="return_book_fine" :name="return_book_fine" :value="return_book_fine">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form @submit.prevent="paidFine">
                                <div class="modal-body">
                                    <input v-if="selectedEmployee != null" type="hidden" :id="return_book_id" :name="return_book_id" :value="return_book_id">
                                    <p>Employee fine for this book is ₱{{this.return_book_fine}}</p>
                                </div>
                                <div class="modal-footer">
                                    <span class="pull-right">
                                        <button class="btn btn-primary">
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <form @submit.prevent="renewBook">
                            <input v-if="selectedEmployee != null" type="hidden" :id="renew_transaction_id" :name="renew_transaction_id" :value="renew_transaction_id">
                            <div class="modal-body">
        ...
        <div class="d-flex justify-content-center" v-if="selectedEmployee != null">
            <div class="col-md-11 col-sm-10" style="padding: 0; margin: 0">
                ...
                <div class="modal-body">
                    <center>
                        <table class='table table-striped table-bordered'>
                            ...
                            <tbody>
                                <tr v-for="employee in searchItems" :id="'employee-' + employee.id">
                                    <td id='employee-number'     style='vertical-align:middle'>{{ employee.employee_id }}</td>
                                    <td id='employee-fullname'   style='vertical-align:middle'>{{ employee.full_name }}</td>
                                    <td id='employee-year'       style='vertical-align:middle'>{{ employee.position }}</td>
                                    <td>
                                        <a href='#' @click="selectEmployee(employee.id)" class='btn btn-primary btn-block'>Select</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <form @submit="borrowBook">
                        <div class="modal-body">
                              <div class="form-group">
                                ...
                                <br>
                                  <input v-if="selectedEmployee != null" type="hidden" :id="borrow_employee_id" name="borrower_id" :value="selectedEmployee.id">
    ...
    export default {
        ...
        methods: {
            ...
            searchNow() {
                ...
                axios.get('/admin/library/book-transaction/api/get/employee?search=' + this.searchbar)
                    .then(response => {
            ...
            selectEmployee(idx) {
                this.selectedEmployee = this.searchItems.find(item => item.id == idx);
                $('#employeesModal').modal('toggle');
                this.searchbar = null,
                this.getBorrowedBooks(this.selectedEmployee.employee_id);
            },
            ...
            borrowBook(){
                axios.post('/admin/library/book-transaction/api/employee-borrow/book', {
                    borrow_employee_id: this.selectedEmployee.employee_id,
            ...
            getBorrowedBooks (employee_id) {
                axios.get('/admin/library/book-transaction/api/get/employee-borrowed-books/' + employee_id)
                        .then(response => {
                            this.borrowedBooks = response.data;
                        });
                this.getUserBookTransactions(this.selectedEmployee.employee_id);
            },

            getUserBookTransactions (employee_id) {
                axios.get('/admin/library/book-transaction/api/get/employee-book-transactions/' + employee_id)
                        .then(response => {
