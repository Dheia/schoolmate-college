                    ...
                    <div v-for="correctAnswer in correctAnswers" v-if="correctAnswer.question_id === question.id"  style="margin-bottom:10px;">
                        <div v-for="studentAnswer in studentAnswers" v-if="studentAnswer.question_id === question.id" >
                            <div class="answer-row">
                                ...
                                <div v-else-if="studentAnswer.fill_blank !== correctAnswer.fill_blank " class="incorrectAnswer">&#10006; <b>incorrectAnswer</b></div>
...
export default {
    ...
    data() {
      ...
      methods: {
           fetchQuestion(){
                axios.get('/student/online-class-quizzes/getResult/',{
                params: {
                    id : this.online_quiz_id,
                    },
                }) .then(response => {
