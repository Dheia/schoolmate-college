  ...
  <div class="limiter">
    <div class="container-login100">
      ...
      <i class="fa fa-check fa-5x" style="color: #FFF; background: #60c878; border-radius: 50%; padding: 10px; position: absolute; top: -55px; left: 50%; transform: translateX(-50%);"></i>
       <h3 class="mt-5"><b>Payment Complete</b></h3>
       ...
       <div class="col-md-12 mt-5 p-5" style="background: #f8f6f6;">
          <div class=" mx-auto profile-card" style="display: table;">
            ...
            <div class="p-1" style="display: table-cell; vertical-align: middle;">
              <h4 class="text-left">{{ $onlinePayment->student->full_name }}</h4>
              <p class="text-left" style="font-size: 1.2rem;">{{ $onlinePayment->student->studentnumber }}</p>
            </div>
          </div>

          <div class="p-5">
            <p class="mb-0" style="font-size: 5em; font-weight: bold;"><span style="font-size: 3rem">PHP</span> {{ number_format($onlinePayment->amount + $onlinePayment->fee, 2) }}</p>
            <p style="font-size: 1.5rem;">{{ $onlinePayment->description }}</p>
          </div>
      ...
      <div class="col-md-12 py-5">
          <center>
            <a href="https://schoolmate-online.net">
              <img class="text-center footer-message" src="{{ asset('images/WIS_LOGO.png') }}" alt="IMG" width="150">
            </a>
          </center>
