			...
			<div class="col-lg-6 col-md-6 col-sm-12 col-md-12 smo-search-group"> 
				<section class="content-header">
					<ol class="breadcrumb">
						...
						<li><a class="text-capitalize active">Class Attendance</a></li>
					</ol>
				</section>
				<h1 class="smo-content-title">
					<span class="text-capitalize">Class Attendance</span>
					<small>All class tap in and tap out</small>
				</h1>
			</div>
		</div>
					...
					<div class="form-group col-md-12">
						<div class="row">
							<div class="col-md-12">
								...
								{{-- <select name="student" id="student" class="form-control" style="display: none;">
									@if( count($students) > 0 )
										@foreach($students as $student)
  	...
  	<script>
    	...
    	$('#btn-run').click(function () {
        	...
        	var studentnumber 	= $('#studentNumber').val();
	      	...
	      	$.ajax({
		        url:  'class-attendance/logs?studentnumber='+ studentnumber +'&date_from=' + date_from + '&date_to=' + date_to + '&period=' + period,
		        success: function (response) {
		        	if(response.status == "ERROR") {
		          	...
		          	var tableRow = '';
		          	$.each(response.classAttendance, function (key, val) {
			            var duration = '';
		            	...
		            	var time_in = val.time_in ? moment(val.time_in, 'HH:mm:ss').format('hh:mm:ss A') : '-';
	            		var time_out = val.time_out ? moment(val.time_out, 'HH:mm:ss').format('hh:mm:ss A') : '-';
		            	tableRow += '<tr>\
