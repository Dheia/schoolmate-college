    ...
    <div class="col-md-12 col-lg-12 oc">
      <div class="row">
        ...
        <div class="col-md-3 col-lg-3 col-xs-12 oc col-two">
          ...
          <div class="col-md-12 col-lg-12 ">
            <div class="box br-0" style="min-height: 0">
              <div class="box-header">
                <a href="{{ url('admin/archive-meeting') }}">{{-- <i class="fa fa-archive"></i> --}} <b>Archived Meetings</b></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-12 col-lg-12 ">
            <a href="#" data-toggle="modal" data-target="#formModal" data-backdrop="static">
        ...
        <div class="col-md-9 col-lg-9 col-xs-12 oc col-one">
          ...
          <!-- Main Panel Title -->
          <div class="col-md-12 col-lg-12 ">
             <h2 class="oc-header-title p-t-0 m-t-0">My Meetings<br></h2>
          </div> 
                      ...
                      <div class="box shadow" style="border-radius: 5px; border-color: #eee;">
                        ...
                        <div class="box-body meeting-info">
                          <div class="row" style="margin: 0">
                            <div class="meeting_content" style="min-height: 200px;">
                              ...
                              <!-- Meeting Employee -->
                              <h6 class="meeting-desc">
                                <b>By:</b> {!! $meeting->employee ? $meeting->employee->fullname : 'Unknown Teacher' !!}
                              </h6>
                              <!-- Meeting Date -->
                              <h6 class="meeting-desc">
                                <b> Date:</b> {!! date("F j, Y", strtotime($meeting->date)) !!}
                              </h6>
                              <!-- Meeting Time -->
                              <h6 class="meeting-desc">
                                <b>Time:</b> {!! date("h:i A", strtotime($meeting->start_time)) !!} - {!! date("h:i A", strtotime($meeting->end_time)) !!}
                              </h6>
                              <br>
                          ...
                          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0">
                            <div class="dropdown">
                              ...
                              <ul class="dropdown-menu pull-right" style="margin-right: -26px; margin-top: 35px;">
                                ...
                                <li>
                                  <a href="{{ url($crud->route . '/' . $meeting->code . '/recordings' )}}" id="viewRecordings" classcode="{{ $meeting->code }}">
                                    View Recordings  
                                  </a>
                                </li>
                                @if(backpack_user()->hasRole('School Head') || backpack_auth()->user()->employee_id == $meeting->employee_id)
                                  <li>
                                    ...
                                    <form action="{{ url($crud->route . '/' . $meeting->code . '/set-archive' )}}" method="POST" id="archived-form{{ $meeting->code }}">
                                      @csrf
                                      <input type="hidden" name="code" value="{{$meeting->code}}">
                                    </form>
                                  </li>
                                ...
                                @if(backpack_user()->hasRole('School Head') || backpack_auth()->user()->employee_id == $meeting->employee_id)
                                  <li>
                                    <a href="{{ asset($crud->route.'/'.$meeting->id.'/edit?code='.$meeting->code) }}">Edit Meeting</a>
                                  </li>
                                  <li>
