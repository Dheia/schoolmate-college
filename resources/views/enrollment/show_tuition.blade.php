...
@section('header')
   {{--  @php
        $other_program_lists        = $data['other_program_lists'];
        $other_service_lists        = $data['other_service_lists'];
        $payment_history            = $data['payment_histories'];
        $gradeLevel                 = $data['tuition']->year_management->year;
        $tuition_name               = $data['tuition']->form_name;
        $selected_other_programs    = $data['selected_other_programs'];
        $selected_other_services    = $data['selected_other_services'];
        $additional_fees            = $data['additional_fees'];
        $discrepancies              = $data['discrepancies'];
        $special_discount_lists     = $data['special_discount_lists'];
        $student                    = $data['student'];
        $totalPaymentHistory        = $data['total_payment_history'];
        $totalSelectedOtherProgram  = $data['total_selected_other_program'];
        $totalSelectedOtherService  = $data['total_selected_other_service'];
        $totalAdditionalFee         = $data['total_additional_fee'];
        $totalDiscrepancy           = $data['total_discrepancy'];
        $totalSpecialDiscount       = $data['total_special_discount'];
        $commitment_payment_id      = $data['commitment_payment']->id;
        $enrollment_id              = $data['enrollment_id'];
        $enrollment                 = $data['enrollment'];
        $tuition                    = $data['tuition'];
        $schoolYear                 = $tuition->school_year->schoolYear;
        $balance                    = $data['remaining_balance'];
        $qbo_discount_items         = $data['qbo_discount_items'];
        $qbo_items                  = $data['qbo_items'];
