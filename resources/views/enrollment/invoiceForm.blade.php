		  	...
		  	<div class="box-header">
			  	...
			  	<div class="col-xs-6">
			  		<div>
			  			...
			  			<h1 style="margin: 0;">{{ $enrollment->student->full_name }}</h1>
			  		</div>
			  	</div>

			  	<div class="col-xs-6">
			  		<div class="pull-right">
						<p class="m-b-0">BALANCE DUE:</p>
						@foreach($enrollment->tuition->grand_total as $grand_total)
							@if($grand_total['payment_type'] == $enrollment->commitment_payment_id)
					  			<h1 style="margin: 0;">₱{{ number_format($grand_total['amount'], 2) }}</h1>
					  		@endif
						@endforeach
			  		</div>
			  	</div>
