...
{{-- 
    	<div class="col-xs-12 m-b-10" style="padding: 0;">
    		
			<div class="col-md-3" style="padding: 0 15px 0 0;">
				@include('vendor.backpack.crud.buttons.gradeSetup.gradeTemplate', ['stack' => 'top'])
			</div>			
      <div class="col-md-3" style="padding: 0 15px 0 0;">
        @include('vendor.backpack.crud.buttons.gradeSetup.section', ['stack' => 'top'])
      </div>
      <div class="col-md-3" style="padding: 0 15px 0 0;">
        @include('vendor.backpack.crud.buttons.gradeSetup.term', ['stack' => 'top'])
      </div>
			<div class="col-md-3" style="padding: 0 15px 0 0;">
				@include('vendor.backpack.crud.buttons.gradeSetup.subject', ['stack' => 'top'])
			</div>
      <div class="col-md-3" style="padding: 0 15px 0 0;">
        @include('vendor.backpack.crud.buttons.gradeSetup.period', ['stack' => 'top'])
      </div>
