          ...
          <div class="box-body">
            @if($report !== null)
              <div id="content">
                  ...
                  <div class="col-sm-6 col-sm-offset-3" >
                   ...
                   <div class="col-sm-12" style="margin-top: 20px;">
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <p class="text-center" style="margin-bottom: 0; font-size: 24px; font-weight: 1000">
                          INVENTORY REPORT
                        </p>
                      </div>
                      <div class="col-md-4">
                ...
                {{-- {{ dd($reports['data'][0]->item_id) }} --}}
                @include('itemInventory.table-inventory-report', ['reports' => $reports['data']])               
    ...
    $('#runReport').click(function () {
      if($('#reportPeriod option:selected').val() == 'custom') {
        ...
        if($('.start_date input').val() !== '' && $('.end_date input').val() !== '') {
          ...
          location.href = '{{ url("admin/item-inventory/inventory-report") }}/' + $('#reportPeriod option:selected').val() + '?start_date=' + $('.start_date input').val() + '&end_date=' + $('.end_date input').val();

        }
        else { alert("Please Enter A Date"); }
      } 
      else {
        location.href = '{{ url("admin/item-inventory/inventory-report") }}/' + $('#reportPeriod option:selected').val();
      }
    });
