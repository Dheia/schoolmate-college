...
<div class="input-group" style="width: 100%;">
    <span class="input-group-addon" id="basic-addon1" style="width: auto;  background: #d2d6de;">Term</span>
    <select name="term_type" id="term" class="form-control" style="width: 100%; display: unset;">
