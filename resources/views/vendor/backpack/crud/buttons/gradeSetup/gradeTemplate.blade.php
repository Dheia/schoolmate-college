...
@php
    ...
    $options = \App\Models\GradeTemplate::get();
    // $options = \App\Models\GradeTemplate::where('teacher_id', backpack_auth()->user()->id)->get();
    // dd($options);
@endphp
...
<div class="input-group" style="width: 100%">
    <span class="input-group-addon" id="basic-addon1" style="width: auto;  background: #d2d6de;">Template</span>
    <select name="template_id" id="template" class="form-control" style="width: 100%; display: unset;">
