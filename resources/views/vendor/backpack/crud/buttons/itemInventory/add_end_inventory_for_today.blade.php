<?php 
	...
	$isEndSet = false;
	if($isExist) {
		if(App\Models\ItemInventoryQuantity::whereDate('created_at', \Carbon\Carbon::today())
													  ->where('is_start_quantity_set', 1))
		{
			$isStartSet = true;
		}
...
@if($isStartSet && $isEndSet)
	<a href="{{ url('admin/item-inventory/end-item-inventory-for-today') }}" class="btn btn-primary">
