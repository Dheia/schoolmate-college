...
function tree_element($entry, $key, $all_entries, $crud)
{
    ...
    if (!isset($entry->tree_element_shown)) {
        ...
        echo '<div><span class="disclose"><span></span></span><b>'.object_get($entry, $crud->reorder_label).' </b><span class="max"><b>'.$entry->max.$sign.'</b></span></div>';
