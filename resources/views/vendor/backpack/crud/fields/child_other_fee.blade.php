...
<div 
    ...
    ng-controller="OtherFeeController" 
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group col-xs-12" style="margin-bottom: 0;">
                            <h4><b><% total_misc_fee | number %></b></h4>
                        </div>
                    <td colspan="2"></td>
                </tr>
...
@if ($crud->checkIfFieldIsFirstOfItsType($field, $fields))
    ...
    @push('crud_fields_scripts')
        ...
        <script>
            ...
            window.angularApp.controller('OtherFeeController', function($scope, $rootScope){
                ...
                $scope.$watch('items', function(a, b){
                    ...
                    $scope.total_misc_fee = 0;

                    if( typeof $scope.items != 'undefined' && $scope.items.length ){

                        angular.forEach($scope.items, function (obj, key) {
                            if(obj.amount === undefined) { $scope.items[key]['amount'] = 0; }
                            $scope.total_misc_fee += obj.amount;
                        });
                    

                        $scope.total_misc_fee = $scope.total_misc_fee;
