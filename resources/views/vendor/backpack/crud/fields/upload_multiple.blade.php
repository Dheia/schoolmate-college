    ...
    <div class="well well-sm file-preview-container">
    	@foreach($values as $key => $file_path)
    		<div class="file-preview">
		        ...
		        @endif
		    	<a id="{{ $field['name'] }}_{{ $key }}_clear_button" href="#" class="btn btn-default btn-xs pull-right file-clear-button" title="Clear file" data-filename="{{ $file_path }}"><i class="fa fa-trash"></i></a>
