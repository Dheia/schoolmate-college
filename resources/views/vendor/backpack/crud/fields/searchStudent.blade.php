...
<div @include('crud::inc.field_wrapper_attributes') >
    ...
    @if(isset($field['prefix']) || isset($field['suffix'])) <div class="input-group"> @endif
        @if(isset($field['prefix'])) <div class="input-group-addon">{!! $field['prefix'] !!}</div> @endif
                    ...
                    <table class="table table-bordered mb-0">
                        <tbody>
                            <tr>
                                ...
                                <td><b><small>Grade Level:</small></b></td>
                                <td id="gradeLevel">&nbsp;</td>
                    ...
                    <a href="#" id="searchStudent" class="btn btn-primary" style="margin-top: 5px;">Search</a>
    {{-- HINT --}}
    @if (isset($field['hint']))
...
@push('after_scripts')
    ...
    <script type="text/javascript">
        ...
        function getStudent (student, cb)
        {
            $.ajax({
                url: '/admin/api/get/student/' + student,
        ...
        function selectStudent(student_id) {
            getStudent(student_id, function (student) {
    ...
    @if($crud->getActionMethod() === "edit")
        @php
            $student = $entry->with('student')->first()->student;
        @endphp
        <script>
