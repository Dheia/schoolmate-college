...
?>
<div ng-app="backPackTableApp" ng-controller="addPaymentController" @include('crud::inc.field_wrapper_attributes') >
...
@if ($crud->checkIfFieldIsFirstOfItsType($field, $fields))
    ...
    @push('crud_fields_scripts')
        ...
        <script>
            ...
            window.angularApp.controller('addPaymentController', function($scope){
