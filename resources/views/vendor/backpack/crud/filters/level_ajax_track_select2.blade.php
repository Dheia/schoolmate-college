...
@push('crud_list_scripts')
	...
	<script>
		var select_filter_track = $('#filter_track_id');
		var select_filter_level = $('#filter_level_id');
		function getTrack () {
			var level_id  = select_filter_level.val();
			$.ajax({
				url: '/{{ $crud->route }}/get-track',
				data: {
					level_id: level_id 
				},
				success: function (response) {
					...
					select_filter_track.html(options);
				}
			});
		} getTrack();
