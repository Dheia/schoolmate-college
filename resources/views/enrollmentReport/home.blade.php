...
@section('after_scripts')
	...
	<script>
		...
		function watchTerm () {
			var term_type = level.find('option:selected').val();
		...
		function view() {
			document.getElementById("form").action = '{{ url($crud->route) }}/show/report';
			document.getElementById("form").target = '_blank';
			$('#form').submit();
			document.getElementById("form").action = '{{ url($crud->route) }}/download/report';
