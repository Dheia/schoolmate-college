	...
	<script>
	    ...
	    doc.autoTable({
            ...
            columns: [
                ...
                { header: "Created by", dataKey: "created" },
                { header: "Last Update by", dataKey: "update" },
		       
		    ],
            columnStyles: {
		        room: { columnWidth: 20 },
		        name: { columnWidth: 30 },
		        Condition: { columnWidth: 20 },
		        building: { columnWidth: 20 },
		        created: { columnWidth: 20 },
		        update: { columnWidth: 20 },
		    },
	        ...
	        didDrawPage: function (data) {
             ...
             var base64Img = "{{ $schoollogo }}";
	            ...
	            doc.setFontSize(8);
	            doc.setFontType("bold");
	            doc.myText("ASSET INVENTORIES LIST", {align: "center"},0,40);
	    ...
	    doc.save('Asset Inventories List {{ Carbon\Carbon::now()->format('m-d-Y') }}.pdf');
	    history.go(-1);
	</script>
</body>
