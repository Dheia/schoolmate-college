          ...
          <div class="info-box">
            <div class="row">
              <div class="col-md-7 col-xs-12 text-center">
                <img class="login-image" src="{{asset('images/parent_login.png')}}" alt="">
              </div>
              <div class="col-md-5 col-lg-5 text-center pull-left login-section">
                <div class="">
                  ...
                  <!-- LOGIN FORM -->
                  <form class="login80-form validate-form mx-auto " role="form" method="POST" action="{{ route('parent.login.submit') }}" 
                    aria-label="{{ __('Login') }}">
                    ...
                    <div class="wrap-input100 validate-input form-group{{ $errors->has('email') ? ' has-error' : '' }}" 
                      ...
                      <input id="" class="input100" type="email" name="email" value="{{ old('email') }}" placeholder="Email" autocomplete="off">
