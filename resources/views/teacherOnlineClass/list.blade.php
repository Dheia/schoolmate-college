      ...
      <div class="">
        ...
        <div class="row m-b-10">
          <div class="col-xs-6">
            ...
            <a href="/{{ $crud->route }}/create?teacher_id={{ request()->get('teacher_id') }}" class="btn btn-primary ladda-button" data-style="zoom-in"><span class="ladda-label"><i class="fa fa-plus"></i> Add Class</span></a>
