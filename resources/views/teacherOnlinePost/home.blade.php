...
@section('content')
  ...
  <div class="row p-l-20 p-r-20">
    ...
    <div class="col-md-8 col-lg-8 col-one">
      ...
      <employee-explore :school_id="'{{ env('SCHOOL_ID') }}'" :user="{{ $user }}"  :spaces_url="'{{ env('DO_SUBDOMAIN') }}'"></employee-explore>
    ...
    <div class="col-md-4 col-lg-4 col-two">
      <div class="box shadow">
              ...
              <div class="box-body with-border" style="padding: 0px 10px 10px 10px;">
                ...
                <div class="col-md-10 col-xs-10">
                  <h5 class="" style="padding: 0px !important; margin: 0px !important">
                    <a href="{{ url('admin/online-post?class_code=' . $class->code)}}">
                      {{ $class->name }}
                    </a>
                  </h5>
                </div>
        ...
        <div class="box-footer with-border br-b-15" style="padding: 10px;">
          <a href="{{ asset('admin/teacher-online-class') }}">View all classes</a>
        </div>
      </div>
      <!-- END RIGHT SIDE BAR -->
    </div>
