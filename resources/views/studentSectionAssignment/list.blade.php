    ...
    <div class="{{ $crud->getListContentClass() }}">
      <div class="">
        ...
        <div class="col-md-4" style="padding: 0 15px 0 0;">
          @include('vendor.backpack.crud.buttons.studentSectionAssignment.level_and_section', ['stack' => 'top'])
        </div>
        <div class="col-md-4" style="padding: 0 15px 0 0;">
          <div class="input-group" style="width: 100%; margin-bottom: 5px;">
              ...
              <select name="section_id" id="level" class="form-control" style="width: 100%; display: unset;">
                  <option value="">-</option>
              </select>
          </div>
        </div>
