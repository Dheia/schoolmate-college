...
<div class="row m-t-20">
	<div class="{{ $crud->getEditContentClass() }}">
		...
		@include('crud::inc.grouped_errors')
		  ...
		  <form method="post"
		  		action="{{ url($crud->route.'/'.$entry->getKey()) }}?class_code={{$class->code}}"
		  ...
		  <div class="col-md-12">
            ...
            <div class="">
                ...
                <button id="btnPost" style="margin-right: 10px;" type="submit" class="btn btn-success" >
              	...
              	<a href="{{ url($crud->route) }}" style="margin-right: 10px;" type="button" class="btn btn-secondary" data-dismiss="modal">
