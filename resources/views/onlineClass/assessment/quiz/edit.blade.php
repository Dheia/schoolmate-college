	...
	<div class="{{ $crud->getEditContentClass() }}">
		...
		@include('crud::inc.grouped_errors')
		  ...
		  <div class="col-md-12">
            ...
            <div class="">
                <a href="{{ url($crud->route . '/create/' . $entry->id . '/questions') }}" style="margin-right: 10px;" class="btn btn-primary pull-right" >
                	Next <span class="fa fa-angle-double-right" role="presentation" aria-hidden="true"></span>
              	</a>
