        ...
        <div class="nav-tabs-custom" style="border-radius: 5px;">
          <div class="box-header with-border">
            <ul class="nav nav-pills">
              <li class="@if(!$errors->count()) active @endif"><a href="#profile" data-toggle="tab" aria-expanded="true">Profile</a></li>
              ...
              <li class="@if($errors->count()) active @endif"><a href="#change-password" data-toggle="tab" aria-expanded="false">Change Password</a></li>
            </ul>
          </div>
          
          <div class="tab-content" style="border-radius: 5px;">
            <!-- START PROFILE INFORMATION -->
            <div class="tab-pane @if(!$errors->count()) active @endif" id="profile">
            ...
            <div class="tab-pane @if($errors->count()) active @endif" id="change-password">
