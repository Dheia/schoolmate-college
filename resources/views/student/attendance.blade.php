...
@section('header')
    {{-- <section class="content-header">
      <h1>
        School Attendance<small>All turnstile tap in and tap out</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href=""></a></li>
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 smo-search-group"> 
        <section class="content-header">
          <ol class="breadcrumb">
            ...
            <li><a class="text-capitalize active">Attendance</a></li>
          </ol>
        </section>
        <h1 class="smo-content-title">
          <span class="text-capitalize">School Attendance</span>
...
@section('after_scripts')
  ...
  <script>
    ...
    $('#btn-run').click(function () {
      ...
      $.ajax({
        url:  'turnstile-attendance/logs?date_from=' + date_from + '&date_to=' + date_to + '&period=' + period,
