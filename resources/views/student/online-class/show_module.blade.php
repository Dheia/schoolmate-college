                  ...
                  @if($module->topics)
                    @if(count($module->topics)>0)
                      @foreach($module->topics as $key => $topic)
                          <a href="{{ url('student/online-class-topic/' . $class->code . '/' . $module->id . '/' . $topic->id) }}">
          ...
          @foreach($modules as $my_module)
            <div class="box-body with-border" style="padding: 0px 10px 10px 10px;">
              ...
              <div class="col-md-10 col-xs-10">
                <h5 class="" style="padding: 0px !important; margin: 0px !important">
                  <a href="{{ url('student/online-class/' . $class->code . '/course/' . $my_module->id) }}">
                    {{ $my_module->title }}
                  </a>
                </h5>
              </div>
