...
<div class="limiter">
  <div class="container-login15 header" style="background: #0e6ea6;">
    <div class="container">
  ...
  <div class="content" style="background: rgb(236, 240, 245); padding: 50px;" id="app">
    @yield('content')
  </div>
  <div class="container-login10 footer" style="background: #222;">
    <div class="container">
      <div class="col-lg-12 col-md-12">
        <img class="sm-logo" height="50" id="schoolLogo" src="{{ asset('images/logo_schoolmate.png') }}" alt="School Logo">
        <p class="text-white credits"> © 2019 SchoolMATE Online | All right reserved.</p>
      </div>
      <br>
    </div>
    <div class="col-lg-12 col-md-12 sm-desc">
        <small class="text-white p-r-125 pull-right">School Management System</small>
      </div>
  </div> 
</div>
