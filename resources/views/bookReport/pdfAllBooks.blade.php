					...
					<table class="table table-bordered table-sm">
						<thead>
							<tr>
								...
								<th class="text-center" style="vertical-align: middle;">Isbn</th>
							...
							@if(count($books)>0)
								@foreach($books as $book)
									...
									<tr>
										...
										<td class="text-center" style="vertical-align: middle;"> {{ $book->code }} </td>
										<td class="text-center" style="vertical-align: middle;"> {{ $book->isbn }} </td>
