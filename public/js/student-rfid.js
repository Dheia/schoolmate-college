// $('.box-footer').remove();
            ...
            function getStudentAccount (student, stud_info) {
                ...
                var acc = '<div class="row"><div class="form-group col-md-10">\
                        ...
                        // console.log(window.paymentHistory);
            ...
            function getPayment(data, student) {
                ...
                $.ajax({
                    ...
                    success: function (payments) {  
                        ...
                        // OTHER PROGRAMS
                        var tr = '';
                        console.log("1 = ", other_program_total);
                        ...
                        console.log("2 = ", other_program_total);
            ...
            function savePayment() {
                ...
                console.log('pm = ', $('#payment_amount').val() + ' : rb = ', remainingBalance.toFixed(2));
